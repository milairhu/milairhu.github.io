      ...
      <div className='h-full w-full bg-slate-50 rounded-xl shadow-lg flex flex-col justify-between pb-4'>
        <div className='flex flex-col h-3/4 w-full'>
          <div className='flex justify-between space-x-2 h-fit w-full items-center bg-slate-300 px-4 py-2 rounded-t-xl'>
            ...
            <div className='text-end text-black font-semibold text-sm md:text-xl md:text-2xl text-wrap'>
              {title}
            </div>
          </div>
            <div className='h-full text-black font-normal text-xs md:text-lg px-4 py-2 italic'>
              <p>{description}</p>
            </div>
        </div>
        <div className='flex items-center justify-between px-4'>
          <div className='flex items-center w-10/12 text-black justify-start text-wrap text-xs md:text-lg'>
