      ...
      <div className='h-full w-full text-white space-y-11'>
        ...
        <div className=' h-3/4 w-full space-y-10 overflow-auto'>
          <div className='flex space-x-5'>
            <h2 className='text-4xl font-semibold w-1/4'>Professionnal experience</h2>
...
· Welcomed customers, Prepared orders, Worked within a team
          ...
          <div className='flex space-x-5'>
            <h2 className='text-4xl font-semibold w-1/4'>Education</h2>
            <div className='w-3/4 space-y-4'>
              <div>
          ...
          <div className='flex space-x-5'>
            <h2 className='text-4xl font-semibold w-1/4'>Computer skills</h2>
            <div className='w-3/4 space-y-4'>
              <div>
...
· Logic Programming
          ...
          <div className='flex space-x-5'>
            <h2 className='text-4xl font-semibold w-1/4'>Extra-Curricular activities</h2>
            <div className='w-3/4 space-y-4'>
              <div>
